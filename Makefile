...
$(eval $(call build-package,dex-k8s-authenticator,1.4.0-r0))
...
$(eval $(call build-package,py3.7-installer,0.5.1-r0))
$(eval $(call build-package,py3.8-installer,0.5.1-r0))
$(eval $(call build-package,py3.9-installer,0.5.1-r0))
$(eval $(call build-package,py3.7-setuptools,67.5.1-r0))
$(eval $(call build-package,py3.8-setuptools,67.5.1-r0))
$(eval $(call build-package,py3.9-setuptools,67.5.1-r0))
$(eval $(call build-package,py3.7-pip,23.0.1-r0))
$(eval $(call build-package,py3.8-pip,23.0.1-r0))
$(eval $(call build-package,py3.9-pip,23.0.1-r0))
$(eval $(call build-package,sourcegraph-grafana,4.4.2-r3))
